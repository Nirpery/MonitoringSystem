#הסקריפט אותו ניתן להפיץ בתחנות ושרתים על מנת לאסוף את המידע ולכתוב לבסיס הנתונים
#יש לשנות את הנתיב בו נמצאים קבצי הסיסמאות ושמות המשתמש
#יש לדאוג שרק למשתמש אשר מריץ את הסקריפט תהיה הרשאה לתיקייה בשרת הקבצים של שמות המשתמש והסיסמאות
